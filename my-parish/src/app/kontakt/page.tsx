    ...
    <div>
      ...
      <PageContainer>
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-neutral-900">parafia@example.com</p>
                </div>
              </div>

              <div className="flex items-start gap-3">
                <Clock className="w-5 h-5 text-neutral-500 mt-1 shrink-0" />
                <div>
                  <p className="text-neutral-600">Godziny otwarcia kancelarii:</p>
          ...
          {/* Map */}
          <div className="bg-white/80 backdrop-blur-sm rounded-lg shadow-md border border-neutral/30 overflow-hidden">
            <iframe
